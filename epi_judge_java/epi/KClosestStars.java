...
public class KClosestStars {
  ...
  // n is the number of elements, k is the input number
  //Optimal solution, O(nlogk) time O(k) space
  public static List<Star> findClosestKStars(Iterator<Star> stars, int k) {
    PriorityQueue<Star> maxHeap = new PriorityQueue<>(k, (o1, o2) -> Double.compare(o2.distance(), o1.distance()));
    while (stars.hasNext()){
