...
public class IsTreeBalanced {
  ...
  /*
   * public static boolean isBalanced(BinaryTreeNode<Integer> root) { if (root ==
   * null) return true; int leftDepth = getHeight(root.left); int rightDepth =
   * getHeight(root.right);
   * 
   * if (Math.abs(leftDepth - rightDepth) > 1) return false; return
